...
def load_cnn():
    ...
    model.load_weights('skin_color.h5')

    return model


def skin_testing(input_image,output_file):

    model = load_cnn()

    category = {0:'Unknown',1:'Not Applicable',2:'1',3:'2',4:'3',5:'4',6:'5',7:'6',8:'7',9:'8'}
    ...
    if ("skin_colour_predict" in keys):
        data1["skin_colour_predict"] = str(category[label])

    if ("skin_colour_predict_perc" in keys):
        data1["skin_colour_predict_perc"] = str(prob) + '%'
