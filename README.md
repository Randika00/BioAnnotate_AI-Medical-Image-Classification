...
The system includes image preprocessing operations such as:
    ...
    ∗ category labeling
    ∗ numerical encoding
    ∗ .npy training file generation

The main objective of this project is to build a strong foundation for Convolutional Neural Network (CNN) training and future automated image classification tasks in healthcare and biomedical research domains.
